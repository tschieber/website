                                ...
                                <a
                                    ...
                                    target="_blank">
                                        ...
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 -960 960 960"
                                            className="button-solid__icon button-solid__icon--download">
                                ...
                                <a
                                    ...
                                    target="_blank">
                                        ...
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 16 16"
                                            className="button-solid__icon button-solid__icon--linkedin">
                                ...
                                <a
                                    ...
                                    target="_blank">
                                        ...
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 16 16"
                                            className="button-solid__icon button-solid__icon--github">
